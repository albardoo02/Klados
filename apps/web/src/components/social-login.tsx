    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-2">
        ...
        <button
          ...
          disabled={loadingType !== null}
          className="flex items-center justify-center gap-2 px-2.5 py-2.5 bg-slate-900 hover:bg-slate-800 text-white rounded-xl text-xs font-medium transition-colors shadow-2xs disabled:opacity-50"
        >
          {loadingType === 'github' ? (
        ...
        <button
          ...
          disabled={loadingType !== null}
          className="flex items-center justify-center gap-2 px-2.5 py-2.5 bg-[#5865F2] hover:bg-[#4752C4] text-white rounded-xl text-xs font-medium transition-colors shadow-2xs disabled:opacity-50"
        >
          {loadingType === 'discord' ? (
            <Loader2 className="w-4 h-4 animate-spin text-white" />
          ) : (
